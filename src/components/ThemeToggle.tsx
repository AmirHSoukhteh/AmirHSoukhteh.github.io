...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-10 items-center gap-2 rounded-lg px-2 text-neutral-700 transition-colors hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-neutral-900"
    ...
    >
      ...
      <span className="hidden text-sm font-medium sm:inline">
        {isDark ? siteConfig.theme.dayMode : siteConfig.theme.nightMode}
      </span>
    </button>
  );
}
